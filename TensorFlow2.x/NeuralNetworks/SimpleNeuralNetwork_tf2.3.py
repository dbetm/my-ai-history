"""
Using the Keras API with TF 2.3, we will be buiding a simple neural
...
# Hidden layer
nn_model.add(ks.layers.Dense(
    32, # 32 units, single neurons
...
# Training evaluation
training_loss, training_accuracy = nn_model.evaluate(
    x=training_images,
    y=training_labels
)
